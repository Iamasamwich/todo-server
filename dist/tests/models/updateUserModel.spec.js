...
var compareHash_1 = __importDefault(require("../../models/functions/compareHash"));
...
describe('updateUserModel', function () {
    var req = {
        session: {},
        body: {},
        params: {}
    ...
    var initialUserId;
    test('it creates a user for testing', function () {
        ...
        return (0, addUserModel_1.default)(req)
            .then(function () { return (0, getUserByEmail_1.default)(conn, 'updateUserModel email'); })
            .then(function (resp) {
    ...
    test('it 401s if youre not logged in', function () {
        var req2 = { session: {} };
        return (0, updateUserModel_1.default)(req2)
            .catch(function (err) {
    ...
    test('it 406s with the wrong email type', function () {
        req.body.email = 1;
        return (0, updateUserModel_1.default)(req)
            .catch(function (err) {
            expect(err.status).toBe(406);
    ...
    test('it 406s with no name', function () {
    ...
    test('it 406s with the wrong name type', function () {
        req.body.name = 1;
        return (0, updateUserModel_1.default)(req)
            .catch(function (err) {
            expect(err.status).toBe(406);
    ...
    test('it 406s with an invalid password', function () {
        req.body.pword = 1;
        return (0, updateUserModel_1.default)(req)
            .catch(function (err) {
            expect(err.status).toBe(406);
    ...
    test('it 401s with the wrong password', function () {
    ...
    test('it lets you update the user', function () {
    ...
    test('the session has been updated', function () {
        var conn = new db_1.default();
        return (0, getUserByEmail_1.default)(conn, 'updated email test')
            .then(function (user) {
            expect(user.id).toEqual(req.session.userId);
            return (0, compareHash_1.default)(user.id, 'updated email test');
        })
            .then(function (bool) {
    ...
    test('it cleans up the tests', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, deleteUserFromDB_1.default)('updated email test')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
