...
var addUserToDB_1 = __importDefault(require("../../models/functions/addUserToDB"));
var deleteUserFromDB_1 = __importDefault(require("../../models/functions/deleteUserFromDB"));
describe('/models/functions/addUserToDB', function () {
    var req = {
        session: {}
    };
    var req2 = {
    ...
    test('it will 406 without a valid body', function () {
    ...
    test('it 406s with the wrong type of email', function () {
        req.body.email = 1;
        return (0, addUserModel_1.default)(req)
            .catch(function (err) {
            expect(err.status).toBe(406);
    ...
    test('it 406s without a name', function () {
    ...
    test('it 406s with an invalid name type', function () {
        req.body.name = 1;
        return (0, addUserModel_1.default)(req)
            .catch(function (err) {
            expect(err.status).toBe(406);
    ...
    test('it 406s with the wrong pword type', function () {
        req.body.pword = 1;
        return (0, addUserModel_1.default)(req)
            .catch(function (err) {
            expect(err.status).toBe(406);
    ...
    test('it adds a user to the db and logs them in', function () {
        req.body = {
    ...
    test('it wont add the same user twice', function () {
        return (0, addUserModel_1.default)(req)
            .catch(function (err) {
    ...
    test('getting db to throw an error', function () {
        ...
        return (0, addUserToDB_1.default)(conn, req)
            .catch(function (err) {
            expect(err.status).toBe(500);
            expect(err.message).toBe('server error');
        })
            .finally(function () { return conn.end(); });
    });
    test('it sanitises the user name', function () {
        req2.body = {
        ...
        return (0, addUserModel_1.default)(req2)
            .then(function () { return (0, getUserModel_1.default)(req2); })
            .then(function (resp) {
    ...
    test('clean up tests', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, deleteUserFromDB_1.default)('test add user email')];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, deleteUserFromDB_1.default)('test add user email 2')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
