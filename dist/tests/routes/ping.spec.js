...
describe('/ping', function () {
    test('GET /ping returns 200 unknown with no user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var test;
    ...
    test('create a user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var test, conn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app)
                ...
                case 1:
                    ...
                    return [2 /*return*/, (0, getUserByEmail_1.default)(conn, 'ping test')
                            .then(function (resp) {
                            userId = resp.id;
                            loggedIn = true;
                            return;
    ...
    test('GET /ping return 200 ok when there is a user logged in', function () { return __awaiter(void 0, void 0, void 0, function () {
        var test;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app)
    ...
    test('clean up tests', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, deleteUserFromDB_1.default)('ping test')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
