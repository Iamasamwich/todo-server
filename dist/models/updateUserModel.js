...
var updateUserInDB_1 = __importDefault(require("./functions/updateUserInDB"));
var compareHash_1 = __importDefault(require("./functions/compareHash"));
var updateUserModel = function (req) {
    ...
    return (0, checkUserIsLoggedIn_1.default)(req)
        ...
        .then(function () { return (0, updateUserInDB_1.default)(conn, req); })
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, logUserIn_1.default)(req, resp.id)];
                case 1:
                    _a.sent();
...
exports.default = updateUserModel;
